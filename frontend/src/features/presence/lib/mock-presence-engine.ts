...
export type PresenceSimulationEngine = {
  generateToken: (request: GenerateQrRequest) => ApiResponse<GenerateQrData>;
  checkIn: (request: CheckInRequest) => ApiResponse<CheckInData>;
  checkStatus: (request: StatusRequest) => ApiResponse<StatusData>;
};

export function createPresenceSimulationEngine(): PresenceSimulationEngine {
