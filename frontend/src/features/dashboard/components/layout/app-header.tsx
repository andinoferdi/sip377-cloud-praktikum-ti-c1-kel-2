    ...
    <header className="surface-elevated sticky top-0 z-99999 flex w-full border-b border-soft">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex w-full items-center justify-between gap-2 border-b border-soft px-3 py-3 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          <button
            className="z-99999 h-10 w-10 items-center justify-center rounded-lg border border-soft text-[var(--token-gray-500)] dark:text-[var(--token-gray-400)] lg:flex lg:h-11 lg:w-11"
          ...
          <button
            ...
            className="surface-interactive z-99999 flex h-10 w-10 items-center justify-center rounded-lg text-[var(--token-gray-700)] dark:text-[var(--token-gray-400)] lg:hidden"
          >
            <svg
              width="24"
              height="24"
            ...
            <div role="search">
              <div className="relative">
                ...
                <input
                  ...
                  className="surface-elevated h-11 w-full rounded-lg border border-soft py-2.5 pl-12 pr-14 text-sm text-[var(--token-gray-800)] shadow-theme-xs placeholder:text-[var(--token-gray-400)] focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:text-[var(--token-white-90)] dark:placeholder:text-[var(--token-white-30)] dark:focus:border-brand-800 xl:w-[430px]"
                />

                <button type="button" className="surface-subtle absolute right-2.5 top-1/2 inline-flex -translate-y-1/2 items-center gap-0.5 rounded-lg border border-soft px-[7px] py-[4.5px] text-xs -tracking-[0.2px] text-[var(--token-gray-500)] dark:text-[var(--token-gray-400)]">
                  <span> Ã¢Å’Ëœ </span>
                  <span> K </span>
                </button>
              </div>
