  ...
  return (
    <div>
      ...
      <div className="space-y-5 sm:space-y-6">
        <div className="rounded-2xl border border-(--token-gray-200) bg-(--token-white) dark:border-(--token-gray-800) dark:bg-(--token-white-3)">
          <div className="px-6 py-5">
            <h3 className="text-base font-medium text-(--token-gray-800) dark:text-(--token-white-90)">
              With Light Background
            </h3>
          </div>
          <div className="p-6 border-t border-(--token-gray-100) dark:border-(--token-gray-800) xl:p-10">
