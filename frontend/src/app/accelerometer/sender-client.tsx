...
export default function AccelerometerSenderClient() {
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <p className="mt-3 max-w-3xl text-sm leading-7 text-(--token-gray-500) dark:text-(--token-gray-400)">
                  Halaman ini khusus membaca sensor perangkat dan mengirim batch
                  data ke Google Apps Script. Untuk memantau data backend,
                  gunakan halaman receiver.
                </p>
                <div className="mt-2">
                  <Link
                    href="/accelerometer/receiver"
          ...
          <div className="grid gap-6 lg:grid-cols-[1.25fr_0.95fr]">
            <div className={`${CARD_CLASS} p-6`}>
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
                  ...
                  <p className="mt-2 text-sm text-(--token-gray-500) dark:text-(--token-gray-400)">
                    Tekan Start untuk membuka stream sensor. Tekan Stop untuk
                    menutup stream dan flush batch terakhir.
                  </p>
                </div>
              ...
              <div className="mt-5 grid gap-3 sm:grid-cols-2">
                ...
                >
                  <Play size={16} />
                  {sessionState.status === "starting" ? "Starting..." : "Start"}
                </button>
                <button
                  type="button"
                  onClick={handleStop}
            ...
            <div className="grid gap-6">
              <div className={`${CARD_CLASS} p-6`}>
                ...
                <div className="mt-5 grid gap-3 md:grid-cols-2">
                  ...
                  <MetricCard
                    label="Last Flush"
                    value={sessionState.lastFlushAt ? "Done" : "--"}
                    accent="text-(--token-gray-900) dark:text-(--token-white)"
                  />
                </div>
                {sessionState.lastFlushError ? (
                ...
                {sessionState.lastStoppedAt ? (
                  <p className="mt-3 text-sm text-emerald-600 dark:text-emerald-300">
                    Sesi berhenti dan flush terakhir menerima{" "}
                    {sessionState.lastAcceptedCount} sampel.
                  </p>
                ) : null}
              </div>
