const FLOW_STEPS = [
  ...
  },
  {
    ...
    description:
      "Mahasiswa scan QR dinamis dan client mengirim user_id, device_id, course_id, session_id, qr_token, dan ts.",
  },
  {
    title: "Server Validasi",
    description:
      "Token harus valid dan belum kadaluarsa. Satu token bisa dipakai banyak mahasiswa sampai expired.",
  },
  {
