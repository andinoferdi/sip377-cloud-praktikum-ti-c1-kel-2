...
Tambahkan permission catalog entries untuk modul `pos_instance` di mekanisme seeding yang aktif (jika digunakan).
...
- Update mekanisme seeding (jika digunakan): tambah permission catalog `pos_instance` dan role mapping.
