...
| Modul 2 Accelerometer | Flow sender-receiver dan endpoint history | flow lama satu halaman live sensor + latest | runtime/frontend dipisah sender dan receiver, chart receiver backend-first + endpoint history publik | rollback / pertahankan split | pertahankan split + history | menyelesaikan kebutuhan modul 2 backend-first dan stabilitas chart | perubahan kontrak publik modul 2 (High) | sinkronkan OpenAPI, artefak docs modul, smoke script, dan README | FE+BE Lead | 2026-03-12 |
